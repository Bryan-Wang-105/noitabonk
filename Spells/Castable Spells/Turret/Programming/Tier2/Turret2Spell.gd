...
func _init():
	name = "User-Acceptance-Testing Sentry"
	rarity = "Uncommon"
	projectile_scene = preload("uid://brh04u0ni4vx")
	projectile_sound = null#load("uid://kqqsvhd1vj0a")
	icon_path = "uid://b3bjkc8upu0fl"
	cast_delay = 1.0
	damage = 35
	modifier = false
	description = "Summons a medium turret to fight on your behalf! Tested on users!"
